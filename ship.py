...
END = -1
=======
>>>>>>> ad54003b0dac524dc98f97ca255286155663074a
...
def setupShip():
<<<<<<< HEAD
	global STARTING_ABSOLUTE_CENTER, STARTING_X ,STARTING_Y, CANVAS_ITEM, HALF_WIDTH, END
=======
...
<<<<<<< HEAD
	...
	CANVAS_ITEM = gameDisplay.display.create_polygon(STARTING_X,
													 STARTING_Y,
													 HALF_WIDTH+STARTING_X,
...
def scaleShipForWindowSize():
	global location, velocity, acceleration, width, height, gapFromBottom, HALF_WIDTH
=======
...
<<<<<<< HEAD
	gameDisplay.display.coords(CANVAS_ITEM,
							   location.x,
							   location.y,
